...
- absolute sigma_gamma targets: pilot: 0.000124559
- sigma ladder (pilot, contract `oracle_headroom_gate.sigma_rel_ladder`): decision rungs 0.00285923; DIAGNOSTIC-ONLY rungs none — swept, reported and plotted, NEVER an input to the DECISION scan  **(LADDER OVERRIDDEN on the command line — this is NOT the contract ladder)**
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| pilot | decision | 0.002859 | 0.0001246 | 0.0001246 | 0.0009866 | 0.0 | +0.0248 | 0.0008 | 1.00 | 0.0065 | 0.0000 |
| pilot | decision | 0.002859 | 0.0001246 | 0.0001246 | 0.0009866 | 0.01 | +0.0044 | 0.0003 | 1.00 | 0.0065 | 0.0000 |
| pilot | decision | 0.002859 | 0.0001246 | 0.0001246 | 0.0009866 | 0.02 | +0.0008 | 0.0002 | 1.00 | 0.0065 | 0.0000 |
...
- sigma_gamma_pilot (NOMINAL target): **0.000124559**
- compared against `sigma_gamma_effective` (contract `oracle_headroom_gate.effective_sigma_reporting.compare_pilot_against`): **0.000124559**
- sigma_delta_effective (delta units, NOT the comparison target): 0.000986586
- clipped_frac on the pilot arm: 0.0000 (region_of_validity.clipped_frac_max = 0.25)
...
- tc = 0.0: NONE — no swept noise level clears the threshold
- tc = 0.01: NONE — no swept noise level clears the threshold
- tc = 0.02: NONE — no swept noise level clears the threshold
